...
Here's a walkthrough of implemented user stories: <a href="Video on Dropbox - click it and it will start playing in your browser.">https://www.dropbox.com/s/2bour2r2e3ciscv/flick_demo.mp4?raw=1</a>
